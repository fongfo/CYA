<?php
    ...
    class RateRequest {
        ...
        public function __construct() {
            ...
            $this->scSku = parse_ini_file("/../../SolidCommerce/scSku_map.ini",true);
            $this->kitSku = parse_ini_file("/../../SolidCommerce/kit_map.ini",true);
        ...
        public function getShipToInfoForImport($shipInfo){
