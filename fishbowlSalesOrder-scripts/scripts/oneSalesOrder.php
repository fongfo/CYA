<?php
    ...
    require_once "/../../UPS/UPSForImport.php";
   ...
   foreach($oneOrder as $key => $value){
        ...
        /*$fbSalesOrder->fbApi->getProducts('Get', $scOrder['OrderItems']['OrderItem']['SKU'], 0, null) ;
        ...
        //check if it is a kit product        
            if(isset($kitSku[$item_value['SKU']])){
                ...
                $fbSalesOrder->fbApi->getProducts('Get', $scSku['DUO'][$item_value['SKU']], 0, null) ;
        ...
        file_put_contents($path, json_encode($result), FILE_APPEND);
        ...
        $totalPublic = $totalPublic + $duoPrice*$item_value['Qty']*2;
            ...
            if(isset($kitSku[$orderItems['OrderItem']['SKU']])){
                ...
                $SalesOrderItem->addChild('KitItemFlag', 'true');
       ...
       /*$requestVar=array(
        ...
        //echo $salesOrderXml;
        //$fbObj = new FBSalesOrder();
        
        if($fbSalesOrder->saveSO($salesOrderXml)){
            echo"haha";
        }else{
            echo"nonono";
