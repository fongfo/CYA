<?php
            //require_once  "/../../fishbowlSalesOrder-scripts/scripts/models/FBSalesOrder.php";
            //require_once "/../../fishbowlSalesOrder-scripts/scripts/models/searchOrder.php";
            //define('SCSKU_INI', "/../../fishbowlSalesOrder-scripts/scripts/models/scSku_map.ini");
            //define('KIT_INI', "/../../fishbowlSalesOrder-scripts/scripts/models/kit_map.ini");
    ...
    class RateRequest {
        ...
        public function __construct() {
            ...
            $this->scSku = parse_ini_file("/../../fishbowlSalesOrder-scripts/scripts/models/scSku_map.ini",true);
            $this->kitSku = parse_ini_file("/../../fishbowlSalesOrder-scripts/scripts/models/kit_map.ini",true);
        ...
        public function getShipToInfoForImport($shipType,$shipInfo){
           ...
           if($shipType=="ShipTo"){
               $shipToInfo = array(        
              "name"=>$shipInfo['BuyerName'],           
              "AddressLine"=>array(
              "AddressLine"=>$shipInfo['ShipToStreet1']
              ),
              "city"=>$shipInfo['ShipToCity'],
              "state"=>'',
              "zip"=>$shipInfo['ShipToZip'],
              "country"=>'US'                               
          );
           }else if($shipType=="ShipFrom"){
               $shipToInfo = array(        
              "name"=>$shipInfo['BuyerName'],           
              "AddressLine"=>array(
              "AddressLine"=>$shipInfo['ShipToStreet1']
        ...
        public function getPackageInfo($sku){
        ...
        public function getPackageInfoForImport($productInfo){
        ...
        //check if there are multiple items
            ...
            $packageInfo = array(        
                ...
                "dim_code"=>'IN',
                "dim_description"=>'iNCHES',                   
                "dim_l"=>$productInfo['len'],
                "dim_w"=>$productInfo['width'],
                "dim_h"=>$productInfo['height'],
                "weight_code"=>"Lbs",
                "weight_description"=>'pounds',
